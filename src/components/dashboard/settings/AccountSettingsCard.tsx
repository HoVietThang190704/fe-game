    ...
    <Card className="border-cyan-400/30 bg-slate-950/40 py-3 text-sky-100 shadow-[0_0_32px_rgba(0,160,255,0.2)] backdrop-blur-md">
      ...
      <CardContent className="space-y-3">
        ...
        <button
          ...
          className="flex w-full items-center justify-between rounded-lg border border-cyan-400/30 bg-slate-900/40 px-4 py-3 text-left hover:bg-cyan-500/10 transition-colors"
        >
          <span className="inline-flex items-center gap-3 font-medium">
